...
import type { HYRequestInterceptors, HYRequestConfig } from './requestType'
import { ElLoading } from 'element-plus'
import type { LoadingOptionsResolved } from 'element-plus/lib/components/loading/src/types'
const DEFAULTLoading:boolean=true //用户控制是否显示loading
class HYRequest {
  ...
  update<T>(config:HYRequestConfig<T>):Promise<T> {
